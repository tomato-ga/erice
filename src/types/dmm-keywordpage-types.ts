...
// APIレスポンス全体のスキーマ
export const GetKVTop100ResponseSchema = z.object({
	keyword: z.string(),
...
// DMMKeywordItemPropsスキーマ（priceとpricesを除外）
export const DMMKeywordItemSchema = DMMItemSchema.omit({ imageURL: true, prices: true }).extend({
	imageURL: z.string(),
	actress: z.string().nullable(), // nullishからnullableに変更
})

// TypeScript型定義
export type DMMItem = z.infer<typeof DMMItemSchema>
export type GetKVTop100Response = z.infer<typeof GetKVTop100ResponseSchema>
export type ErrorResponse = z.infer<typeof ErrorResponseSchema>
export type DMMKeywordItemProps = z.infer<typeof DMMKeywordItemSchema>
