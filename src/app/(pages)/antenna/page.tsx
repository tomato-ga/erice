...
const NavItem: React.FC<{ href: string; label: string; active?: boolean; external?: boolean }> =
	React.memo(({ href, label, active, external }) => (
...
// 		<nav className="mb-4">
// 			{['About', '規約', 'プライバシーポリシー', 'お問い合わせ'].map((item, index) => (
